...
import PdfDocument from './DownloadSlip';
                    ...
                    data && data.data.map(d => (
                        <div className='mb-8' key={d._id}>
                            <Card>
                                ...
                                <CardActions>
                                    <PDFDownloadLink
                                        document={<PdfDocument user={user} info={d}/>}
                                        fileName={fileName}
                                    >
                                        {({ blob, url, loading, error }) =>
                                            loading ? "Loading..." : <Button size="small" color="primary">Download Slip</Button>
                                        }
                                    </PDFDownloadLink>
                                </CardActions>
                            </Card>
