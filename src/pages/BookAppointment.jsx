      ...
      <section className="bg-midWhite min-h-[100vh] py-4">
        <div className="rounded-2xl w-full shadow-lg flex justify-between bg-[#fff]">
          <div className="py-8 px-8">
            <h1 className="text-2xl">Schedule Appointments, <span className="text-hint">{user.first_name}{" "}{user.last_name}</span></h1>
            <p className="mt-4">You are in control of your health, you can always update your <Link to='/user-info'><Button size="small" color="primary">Appointment Settings</Button></Link> before booking an appointment </p>
